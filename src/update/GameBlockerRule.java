	...
	public boolean moveValidationProcessing(Movable movable,
		...
		for (MoveBlocker moveBlocker : blockers) {
			try {
				...
				if (a.contains(b.getMaxX(), b.getMaxY())
						|| (a.contains(b.getMinX(), b.getMaxY()))
						|| a.contains(b.getMaxX(), b.getMinY())
						|| a.contains(b.getMinX(), b.getMinY()))
					if (moveBlocker instanceof BombDrawable)
						continue;
				// -------------------------------
				return false;
			}
