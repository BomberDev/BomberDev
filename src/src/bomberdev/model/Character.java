...
public class Character extends GameMovable implements BomberEntity, MoveBlocker {
	...
	/**
	 * The fire power of the bomb in number of health points taken when it
	 * damages.
	 */
	...
	public Character(GameUniverse gameUniverse) {
		this(gameUniverse, DEFAULT_POWER, DEFAULT_AREA, DEFAULT_HEALTH,
				DEFAULT_STOCK);
		init();
	}

	public Character(GameUniverse gameUniverse, int bombPower, int bombArea,
			int healthPoints, int stockBombs) {
		super();
	...
	protected void init() {
		...
		((GameMovableDriverDefaultImpl) this.moveDriver)
